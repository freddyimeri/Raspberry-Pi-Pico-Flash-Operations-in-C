...
2. [Getting Started](#getting-started)
   ...
   - [Installation](#installation)
     - [Prepare the Raspberry Pi Pico](#prepare-the-raspberry-pi-pico)
     - [Building the Project](#building-the-project)
     - [Deploy the Firmware](#deploy-the-firmware)
...
4. [Function Details: `flash_write_safe`](#function-details-flash_write_safe)
   - [Overview](#overview)
   - [Signature](#signature)
...
5. [Function Details: `flash_read_safe`](#function-details-flash_read_safe)
   - [Overview](#overview-1)
   - [Signature](#signature-1)
   - [Parameters](#parameters-1)
   - [Operational Logic](#operational-logic-1)
   - [Error Handling](#error-handling)
   - [Diagram](#diagram-1)
   - [Example Usage](#example-usage-1)
   - [Capabilities and Limitations](#capabilities-and-limitations-1)
   - [Additional Notes](#additional-notes)

6. [Function Details: `flash_erase_safe`](#function-details-flash_erase_safe)
   - [Overview](#overview-2)
   - [Signature](#signature-2)
   - [Parameters](#parameters-2)
   - [Operational Logic](#operational-logic-2)
   - [Error Handling](#error-handling-1)
   - [Diagram](#diagram-2)
   - [Example Usage](#example-usage-2)
   - [Capabilities and Limitations](#capabilities-and-limitations-2)
   - [Additional Notes](#additional-notes-1)

7. [Structured Data Management](#structured-data-management)
   - [Flash Data Structure](#flash-data-structure)
   - [Device Configuration Structure](#device-configuration-structure)

8. [Testing Coverage for Flash Memory Operations](#testing-coverage-for-flash-memory-operations)
   - [Detailed Testing Descriptions](#detailed-testing-descriptions)
